                ...
                <div className="relative p-8">
                    <CardHeader className="p-0 mb-6">
                        ...
                        <CardDescription className="mt-2">
                            Dashboard'da görüntülemek istediğiniz endeksleri seçin.
                        </CardDescription>
                    </CardHeader>
                    ...
                    <div className="mb-6">
                        ...
                        <div className="space-y-2">
                            {indices.map((index) => (
                                <div key={index.id} className="flex items-center justify-between p-3 bg-gray-50/50 dark:bg-gray-800/50 rounded-lg border border-gray-200/50 dark:border-gray-700/50">
                                    <div>
